...
Set up this repo for development: the **Inkwell** app, the **[Super Simple Software Factory](https://github.com/disler/super-simple-software-factory)** (the ADW engine this repo runs, vendored at `.claude/skills/sssf/`), and the separately-installed **[sbx](https://github.com/jeffjacobsen/sbx)** orchestrator. This checks the toolchain, installs app dependencies, verifies `.env`, and runs the `sbx` preflight, without starting any servers. It is an interactive, agentic process: ask the user when a choice is needed.
