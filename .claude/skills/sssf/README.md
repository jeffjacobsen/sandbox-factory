...
> **This is the skill's own documentation.** It lives beside the skill so it
> travels with it: copy `.claude/skills/sssf/` into any repo and this comes too.
> Originally the README of a standalone repo, folded in here when that repo's
> only remaining content became a duplicate of this directory.
...
This project is built on [super-simple-software-factory](https://github.com/disler/super-simple-software-factory) by **IndyDevDan** ([@disler](https://github.com/disler)) — the original repo, and the source of the skill-as-product design, the ADW model, the envelope-and-gate contract, and the trace pipeline described above.
